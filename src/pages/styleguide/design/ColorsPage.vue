...
const semanticGroups: SemanticGroup[] = [
  ...
  {
    label: 'Status',
    desc: 'Use the base color for text/icons, -subtle for backgrounds, and -strong for text on a -subtle background.',
    tokens: [
      {
        name: 'success',
        var: '--success',
      ...
      },
      {
        ...
        light: '#14532d',
        dark: '#86efac',
        usage: 'Text on success-subtle background',
      },
      {
        name: 'warning',
        var: '--warning',
      ...
      },
      {
        ...
        light: '#78350f',
        dark: '#fcd34d',
        usage: 'Text on warning-subtle background',
      },
      {
        name: 'danger',
        var: '--danger',
      ...
      },
      {
        ...
        light: '#b91c1c',
        dark: '#b91c1c',
        usage: 'Danger button hover background',
      },
      {
        name: 'danger-subtle',
        var: '--danger-subtle',
      ...
      },
      {
        ...
        light: '#7f1d1d',
        dark: '#fca5a5',
        usage: 'Text on danger-subtle background',
      },
    ],
  },
];
