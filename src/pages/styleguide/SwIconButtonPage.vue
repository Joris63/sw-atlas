...
const propRows: PropRow[] = [
  { name: 'label',    type: 'string',                                                                required: true, description: 'Accessible label — rendered as aria-label. Always required.' },
  { name: 'icon',     type: 'string',                                                default: '—',           description: 'Lucide icon name. If omitted, renders the default slot instead.' },
  { name: 'variant',  type: "'primary' | 'outline' | 'ghost' | 'plain' | 'danger'", default: "'primary'",   description: 'Visual style of the button.' },
  { name: 'size',     type: "'2xs' | 'xs' | 'sm' | 'md' | 'lg'",                   default: "'md'",         description: 'Size of the button.' },
  { name: 'as',       type: 'string',                                                default: "'button'",     description: 'HTML element or component to render as.' },
  { name: 'rounded',  type: 'boolean',                                               default: 'false',        description: 'Fully round corners — use for pills and avatar-style buttons.' },
