...
const propRows: PropRow[] = [
  { name: 'for',       type: 'string',            default: '—',       description: "Associates the label with an input's id — passed as the HTML for attribute." },
  { name: 'size',      type: "'xs' | 'sm'",        default: "'sm'",   description: 'Font size.' },
  { name: 'uppercase', type: 'boolean',             default: 'false',  description: 'Renders in uppercase with letter-spacing. Use for section headers, not form labels.' },
  { name: 'required',  type: 'boolean',             default: 'false',  description: 'Appends a red asterisk (*) to signal a required field.' },
]
...
<template>
    ...
    <SwPage title="SwLabel" description="Form field labels and section headings. Use the for prop to associate with an input.">
