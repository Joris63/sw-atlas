...
const propRows: PropRow[] = [
  { name: 'as',     type: 'string',                                  default: "'p'",       description: 'HTML element to render as (e.g. span, div, li).' },
  { name: 'size',   type: "'xs' | 'sm' | 'base' | 'lg' | 'xl'",    default: "'base'",    description: 'Font size.' },
  { name: 'weight', type: "'normal' | 'medium' | 'semibold'",        default: "'normal'",  description: 'Font weight.' },
  { name: 'color',  type: "'default' | 'muted' | 'subtle' | 'inverse'", default: "'default'", description: 'Text color token. Use muted for secondary copy, subtle for placeholders.' },
]
...
<template>
    ...
    <SwPage title="SwText" description="Body copy rendered as a paragraph by default. Configurable size, color, and weight.">
